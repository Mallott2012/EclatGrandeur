...
// Parse a comma/space separated list of sizes in cm (decimals allowed) → number[].
const sizesCm = z.preprocess((v) => {
...
export const CreateBraceletSettingSchema = z.object({
...
export const UpdateBraceletSettingSchema = CreateBraceletSettingSchema.partial()

export type CreateBraceletSettingInput = z.infer<typeof CreateBraceletSettingSchema>
export type UpdateBraceletSettingInput = z.infer<typeof UpdateBraceletSettingSchema>
