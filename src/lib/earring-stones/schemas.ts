...
export const CreateEarringStoneSchema = z.object({
  earring_setting_id: z.preprocess((v) => (v === '' || v == null ? null : v), z.string().uuid().nullable()),
...
export const UpdateEarringStoneSchema = CreateEarringStoneSchema.partial()

export type CreateEarringStoneInput = z.infer<typeof CreateEarringStoneSchema>
export type UpdateEarringStoneInput = z.infer<typeof UpdateEarringStoneSchema>
