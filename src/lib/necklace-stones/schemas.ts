...
export const CreateNecklaceStoneSchema = z.object({
  necklace_setting_id: z.preprocess((v) => (v === '' || v == null ? null : v), z.string().uuid().nullable()),
...
export const UpdateNecklaceStoneSchema = CreateNecklaceStoneSchema.partial()

export type CreateNecklaceStoneInput = z.infer<typeof CreateNecklaceStoneSchema>
export type UpdateNecklaceStoneInput = z.infer<typeof UpdateNecklaceStoneSchema>
