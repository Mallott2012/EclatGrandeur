  ...
  return (
    <div className="container-luxe py-14 md:py-20">
                ...
                <div className="flex flex-1 flex-col">
                  ...
                  <dl className="mt-3 flex flex-col gap-1 text-xs font-light text-ink/60">
                    <div className="flex justify-between">
                      <dt>Setting</dt>
                      <dd>{formatMoney({ amount: item.ringConfig.settingPrice, currency: 'GBP' })}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt>Diamond</dt>
                      <dd>{formatMoney({ amount: item.ringConfig.diamondPrice, currency: 'GBP' })}</dd>
                    </div>
      ...
      <EnquiryModal
        ...
        cartToken={firstConfiguredRing ? cartToken : undefined}
      />
    </div>
  );
}
