// Plain helpers shared by the bracelet-stone server actions.
// NOT a 'use server' module — those may only export async functions.

import type { z } from 'zod'

export function parseBraceletStoneFormData(formData: FormData) {
  return {
    bracelet_setting_id: formData.get('bracelet_setting_id') || null,
