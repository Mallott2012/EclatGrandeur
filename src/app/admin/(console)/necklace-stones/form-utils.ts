// Plain helpers shared by the necklace-stone server actions.
// NOT a 'use server' module — those may only export async functions.

import type { z } from 'zod'

export function parseNecklaceStoneFormData(formData: FormData) {
  return {
    necklace_setting_id: formData.get('necklace_setting_id') || null,
